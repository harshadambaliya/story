...
<section class="st-landing-section st-story-landing-section" style=" background-image: url(http://story.notionprojects.tech/assets/images/story-img.png);">
    <div class="container">
        <div class="text-center">
            <h1 class="st-section-title">26 मार्च, 2025 पटना, भारत</h1>
    ...
    <div class="container">
        <div class="st-story-content">
            <div class="st-story-content__inner">
                <p>पटना के डैमवे कंपनी में एक रीजनल सेल्स मैनेजर के पोस्ट पर काम करते हुए मुझे लगभग 3 साल हो गए हैं |</p>
                <p>नेटवर्क मार्केटिंग की इस नौकरी से महीने भर का ख़र्च तो निकल जाता है | लेकिन अब घुटन सी महसूस होने लगी है |</p>
                <p>दिन भर रोड पर रहना, टारगेट पूरा करने के लिए लोगों के पीछे भागना...अपने दोस्तों तक को नहीं छोड़ा |</p>
                <p>अब तो वे मुझे देखते ही बहाना मार कर निकल जाते हैं |</p>
                <a href="#">अन्वेष को छोड़कर...</a>
            </div>
            <div class="text-center">
                <button type="button" class="btn btn-danger">Save For Later</button>
            </div>
